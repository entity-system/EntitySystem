...
namespace EntitySystem.Client.Components.Form.Input.DateTime;

public class FormInputDateTime<TValue> : InputDate<TValue>
{
    ...
    protected override string FormatValueAsString(TValue value)
    {
        return value switch
        {
            System.DateTime dateTimeValue => BindConverter.FormatValue(dateTimeValue, DateFormat, CultureInfo.InvariantCulture),
